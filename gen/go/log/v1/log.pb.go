...
// Streaming unit
type ProduceStreamRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Record        *Record                `protobuf:"bytes,1,opt,name=record,proto3" json:"record,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *ProduceStreamRequest) Reset() {
	*x = ProduceStreamRequest{}
	mi := &file_log_v1_log_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ProduceStreamRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProduceStreamRequest) ProtoMessage() {}

func (x *ProduceStreamRequest) ProtoReflect() protoreflect.Message {
	mi := &file_log_v1_log_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProduceStreamRequest.ProtoReflect.Descriptor instead.
func (*ProduceStreamRequest) Descriptor() ([]byte, []int) {
	return file_log_v1_log_proto_rawDescGZIP(), []int{5}
}

func (x *ProduceStreamRequest) GetRecord() *Record {
	if x != nil {
		return x.Record
	}
	return nil
...
const file_log_v1_log_proto_rawDesc = "" +
	...
	"\x06record\x18\x01 \x01(\v2\x0e.log.v1.RecordR\x06record\">\n" +
	"\x14ProduceStreamRequest\x12&\n" +
	"\x06record\x18\x01 \x01(\v2\x0e.log.v1.RecordR\x06record\"/\n" +
	"\x15ProduceStreamResponse\x12\x16\n" +
	"\x06offset\x18\x01 \x01(\x04R\x06offset\".\n" +
	"\x14ConsumeStreamRequest\x12\x16\n" +
	"\x06offset\x18\x01 \x01(\x04R\x06offset\"?\n" +
	"\x15ConsumeStreamResponse\x12&\n" +
	"\x06record\x18\x01 \x01(\v2\x0e.log.v1.RecordR\x06record2\xae\x02\n" +
	"\n" +
	"LogService\x12<\n" +
	"\aProduce\x12\x16.log.v1.ProduceRequest\x1a\x17.log.v1.ProduceResponse\"\x00\x12<\n" +
	"\aConsume\x12\x16.log.v1.ConsumeRequest\x1a\x17.log.v1.ConsumeResponse\"\x00\x12R\n" +
	"\rProduceStream\x12\x1c.log.v1.ProduceStreamRequest\x1a\x1d.log.v1.ProduceStreamResponse\"\x00(\x010\x01\x12P\n" +
	"\rConsumeStream\x12\x1c.log.v1.ConsumeStreamRequest\x1a\x1d.log.v1.ConsumeStreamResponse\"\x000\x01B-Z+github.com/k20ku/proglog/proto/log/v1;logv1b\x06proto3"
...
var file_log_v1_log_proto_goTypes = []any{
	...
	(*ProduceStreamRequest)(nil),  // 5: log.v1.ProduceStreamRequest
	(*ProduceStreamResponse)(nil), // 6: log.v1.ProduceStreamResponse
	(*ConsumeStreamRequest)(nil),  // 7: log.v1.ConsumeStreamRequest
	(*ConsumeStreamResponse)(nil), // 8: log.v1.ConsumeStreamResponse
}
var file_log_v1_log_proto_depIdxs = []int32{
	...
	0, // 2: log.v1.ProduceStreamRequest.record:type_name -> log.v1.Record
	0, // 3: log.v1.ConsumeStreamResponse.record:type_name -> log.v1.Record
	...
	5, // 6: log.v1.LogService.ProduceStream:input_type -> log.v1.ProduceStreamRequest
	7, // 7: log.v1.LogService.ConsumeStream:input_type -> log.v1.ConsumeStreamRequest
	...
	6, // 10: log.v1.LogService.ProduceStream:output_type -> log.v1.ProduceStreamResponse
	8, // 11: log.v1.LogService.ConsumeStream:output_type -> log.v1.ConsumeStreamResponse
